        ...
        onSuccess: async (appointment) => {
          ...
          try {
            ...
            if (emailResponse.ok) {
              ...
              console.log("⚠️ Email service not configured - appointment still booked successfully");
            }
          } catch (error) {
            console.log("⚠️ Email service not available - appointment still booked successfully");
          }
