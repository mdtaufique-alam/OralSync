...
export default async function WelcomeSection() {
  ...
  return (
    <div className="relative z-10 bg-gradient-to-br from-primary/10 via-primary/5 to-background rounded-3xl p-8 border border-primary/20 mb-8 overflow-hidden">
      <div className="flex items-center justify-between">
        ...
        <div className="lg:flex hidden items-center justify-center size-32 bg-gradient-to-br from-primary/20 to-primary/10 rounded-full ">
          <Image src="/logo.png" alt="OralSync" width={64} height={64} className="w-16 h-16" />
        </div>
      </div>
    </div>
  );
